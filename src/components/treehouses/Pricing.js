              ...
              <div class="animated animatedFadeInUp p-8 bg-gray-300 rounded">
                ...
                <ul class="mb-8 space-y-2">
                  <li class="flex items-center">
                    ...
                    <p class="font-medium text-gray-700">Private rooms</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-700">Skywalk</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
                    ...
                    <p class="font-medium text-gray-700">Free wifi and Tv accessories</p>
                  </li>
                  <li class="flex items-center">
                    <div class="mr-3">
                      <svg
