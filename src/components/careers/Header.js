const Header = () => {
    ...
    <div className="-mt-20 mb-20">
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="header animated fadeInUp max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          <div>
          ...
          <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            <span className="relative inline-block">
              <svg
                viewBox="0 0 52 24"
                fill="currentColor"
                className="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20 text-orange lg:w-32 lg:-ml-28 lg:-mt-10 sm:block"
              >
                <defs>
                  <pattern
          ...
          <p className="text-base text-gray-700 md:text-lg">
            We work hard every day so that you can have the awesomest adventures and make the best memories of your life
          </p>
        </div>
        <div className="header2 animated fadeInUp grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex">
            <img
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-sm text-gray-800">Trip Planner</p>
            </div>
          </div>
          <div className="flex">
            <img
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-sm text-gray-800">Travel Researcher</p>
            </div>
          </div>
        </div>
      </div>
