            ...
            <div className="flex flex-col mt-20 items-center justify-between xl:flex-row">
              ...
              <div className="w-full mt-20 max-w-xl xl:px-8 xl:w-5/12">
                <div className="header2 bg-white rounded shadow-2xl p-7 sm:p-10">
                  ...
                  <Btn primary={true} round={true} className="header5 animated fadeInUp inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded-full shadow-md bg-orange hover:bg-white focus:shadow-outline focus:outline-none">View Destination</Btn>
                </div>
              </div>
            </div>
          </div>
