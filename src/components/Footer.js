...
const Footer = () => {
    return (
      <div className="relative mt-16 bg-eggshell">
        <svg
          className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-eggshell"
        ...
        <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
            <div className="md:max-w-md lg:col-span-2">
              ...
              >
                <span className="ml-2 text-xl font-bold tracking-wide text-orange uppercase">
                  Xplore
                </span>
              </a>
