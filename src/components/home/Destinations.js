        ...
        <div className="bg-eggshell">
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-eggshell">
                <div className="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
                    <h2 className="animated animatedFadeInUp max-w-lg mb-5 font-sans text-3xl font-bold tracking-tight text-orange sm:text-4xl sm:leading-none md:mb-6 group">
                    ...
                    <p className="animated animatedFadeInUp text-gray-700 lg:text-sm lg:max-w-md">
                ...
                <div className="grid gap-6 row-gap-5 mb-8 lg:grid-cols-4 sm:row-gap-6 sm:grid-cols-2">
                    <a href="/xplore" aria-label="View Item">
